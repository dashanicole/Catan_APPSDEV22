...
namespace ParkingSystemDesign.controller
{
    internal class DatabaseManager
    {
        ...
        private static string userId = "", logId = "", vehicId = "", slotId = "", tranId = "";
        ...
        public static bool existVPlate(string plateno)
        {
            ...
            //    + vhclTB + " WHERE userId = @userId AND vehicPlate = @vehicPlate;";
            string query = "USE " + dbName + "; SELECT COUNT(*) FROM "
        ...
        public static int getVCount()
        {
            ...
            //    + " WHERE userId = @userId AND vehicParkoutT IS NULL;";
            string query = "USE " + dbName + "; SELECT COUNT(*) FROM " + vhclTB
        ...
        public static List<string> getVPlate()
        {
            ...
            //    + vhclTB + " WHERE userId = @userId AND vehicParkoutT IS NULL;";
        ...
        public static List<string> getVPlate1()
        {
            List<string> plateno = new List<string>();
            //string query = "USE " + dbName + "; SELECT vehicPlate FROM "
            //    + vhclTB + " WHERE userId = @userId AND vehicParkoutT IS NOT NULL;";
            string query = "USE " + dbName + "; SELECT vehicPlate FROM "
        ...
        public static List<string> getVTtlhrsHist()
        {
            ...
            //string query = "USE " + dbName + "; SELECT vehicTotalhrs FROM "
            //    + vhclTB + " WHERE userId = @userId;";
        ...
        public static List<string> getVTtlamntHist()
        {
            ...
            //string query = "USE " + dbName + "; SELECT vehicTotalamnt FROM "
            //    + vhclTB + " WHERE userId = @userId;";
        ...
        //        cmd = new SqlCommand("USE " + dbName + "; DELETE FROM " + vhclTB + " WHERE vehicPlate = @vehicPlate;", con);
        //        cmd.Parameters.AddWithValue("@vehicPlate", plateno);
        ...
        //        else
        //        {
        //            MessageBox.Show("Transaction Failed!", "Parkin", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        public static void insertVOutInfo(string plateno, string parkout, string ttlhrs, string ttlamnt)
        {
            try
            {
                ...
                //    + "vehicTotalhrs = @vehicTotalhrs, vehicTotalamnt = @vehicTotalamnt WHERE userId = @userId "
                //    + "AND vehicPlate = @vehicPlate", con);
                cmd = new SqlCommand("USE " + dbName + "; UPDATE " + vhclTB + " SET vehicParkoutT = @vehicParkoutT, "
        ...
        public static void parkSlot()
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    //slotId = Convert.ToString(result);
        ...
        //public static void exitSlot()
        //{
        //    string query = "USE " + dbName + "; UPDATE " + sltTB + " SET userId = NULL, "
        //        + "vehicId = NULL, slotOccpncy = 0 WHERE slotOccpncy = 1 AND vehicId = @vehicId;";
        //    string parkedSlot = "";
        ...
        //        if (rows > 0)
        //        {
        //            MessageBox.Show("1 slot/s CLEARED!", "Parking Slot", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //        }
        //        else
        //        {
        //            MessageBox.Show("Transaction Failed!", "Parking Slot Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //public static void addTransact(DateTime dt)
        //{
        //    try
        //    {
        //        openCon(); // Ensure the connection is opened before the loop

        //        cmd = new SqlCommand("USE " + dbName + "; INSERT INTO " + tranTB + " (userId, vehicId, slotId, tranDate) "
        //                + "VALUES (@userId, @vehicId, @slotId, @tranDate); SELECT SCOPE_IDENTITY();", con);
        ...
        //        else
        //        {
        //            MessageBox.Show("Transaction Failed!", "Transaction", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
