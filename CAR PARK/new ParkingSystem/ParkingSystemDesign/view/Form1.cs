...
namespace ParkingSystemDesign.view
{
    public partial class Form1 : Form
    {
        ...
        public List<string> platenoL = new List<string>(); //vtypeL, vbrandL, dtinL;
        ...
        //public bool isOpenedDash = false, isOpenedPI = false, isOpenedPO = false, isOpenedHist = false;
        ...
        private void parkIn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //parkin.FormClosed += Parkin_FormClosed;
        ...
        private void parkOut_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //parkout.FormClosed += Parkout_FormClosed;
        ...
        private void parkHistory_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //parkhistory.FormClosed += Parkhistory_FormClosed;
