namespace ParkingSystemDesign.view
{
    partial class formParkIn
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridViewParkin.Size = new Size(431, 360);
            ...
            // deleteParkinButton
            // 
            deleteParkinButton.BackColor = Color.WhiteSmoke;
            deleteParkinButton.Font = new Font("Yu Gothic", 11.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
            deleteParkinButton.ForeColor = SystemColors.ActiveCaptionText;
            deleteParkinButton.Location = new Point(627, 435);
            deleteParkinButton.Name = "deleteParkinButton";
            deleteParkinButton.Size = new Size(101, 29);
            deleteParkinButton.TabIndex = 3;
            deleteParkinButton.Text = "DELETE";
            deleteParkinButton.UseVisualStyleBackColor = false;
            deleteParkinButton.Click += button2_Click;
            // 
            // label6
            // 
            ...
            label6.Location = new Point(297, 430);
            label6.Name = "label6";
            label6.Size = new Size(255, 34);
            label6.TabIndex = 4;
            label6.Text = "Want to delete? Click the very left of the \r\nindex and then click DELETE.\r\n";
            // 
            // formParkIn
            // 
            ...
            Controls.Add(label6);
            Controls.Add(deleteParkinButton);
        ...
        public Button deleteParkinButton;
